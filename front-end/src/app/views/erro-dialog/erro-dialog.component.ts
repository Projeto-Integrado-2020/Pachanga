...
export class ErroDialogComponent implements OnInit {
  ...
  ngOnInit() {
    switch (this.erro) {
      ...
      case 'PRODDMEZ': this.erro = this.translate.instant('ERRO.PRODDMEZ'); break;
      case 'FESTNINI': this.erro = this.translate.instant('ERRO.FESTNINI'); break;
      case 'ESTOCITE': this.erro = this.translate.instant('ERRO.ESTOCITE'); break;
      case 'QNTATLDF': this.erro = this.translate.instant('ERRO.QNTATLDF'); break;
      case 'NOMEAREA': this.erro = this.translate.instant('ERRO.NOMEAREA'); break;
      case 'AREANFOU': this.erro = this.translate.instant('ERRO.AREANFOU'); break;
      case 'LOTEVING': this.erro = this.translate.instant('ERRO.LOTEVING'); break;
      case 'PREILOTE': this.erro = this.translate.instant('ERRO.PREILOTE'); break;
      case 'QUAILOTE': this.erro = this.translate.instant('ERRO.QUAILOTE'); break;
      case 'NOMELOTE': this.erro = this.translate.instant('ERRO.NOMELOTE'); break;
      case 'DATEINFE': this.erro = this.translate.instant('ERRO.DATEINFE'); break;
      case 'LOTENFOU': this.erro = this.translate.instant('ERRO.LOTENFOU'); break;
      ...
      case 'SYMPNFOU': this.erro = this.translate.instant('ERRO.SYMPNFOU'); break;
      case 'CPFNOFOU': this.erro = this.translate.instant('ERRO.CPFNOFOU'); break;
      case 'ENDENFOU': this.erro = this.translate.instant('ERRO.ENDENFOU'); break;
      case 'DADBEXIS': this.erro = this.translate.instant('ERRO.DADBEXIS'); break;
      case 'DADBNFOU': this.erro = this.translate.instant('ERRO.DADBNFOU'); break;
      case 'CUPMDUPL': this.erro = this.translate.instant('ERRO.CUPMDUPL'); break;
      case 'CUPMNFOU': this.erro = this.translate.instant('ERRO.CUPMNFOU'); break;
