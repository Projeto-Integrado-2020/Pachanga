...
export class EditarFestaComponent implements OnInit {
  ...
  setFormValues() {
    ...
    this.f.categoriaPrincipal.setValue(this.festa.categoriaPrimaria.codCategoria);
    this.f.categoriaSecundaria.setValue(this.festa.categoriaSecundaria === null ? undefined : this.festa.categoriaSecundaria.codCategoria);
