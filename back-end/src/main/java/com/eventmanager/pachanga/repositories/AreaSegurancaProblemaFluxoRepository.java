...
public interface AreaSegurancaProblemaFluxoRepository extends JpaRepository<AreaSegurancaProblemaFluxo, Integer>{
	...
	@Query(value = "SELECT COUNT(DISTINCT asp.codAreaProblema) FROM AreaSegurancaProblemaFluxo asp WHERE asp.codUsuarioResolv = :codUsuario AND asp.statusProblema = :statusProblema AND asp.codFesta = :codFesta")
	public int findQuantidadeProblemasResolvidosByUsuario(Integer codUsuario, String statusProblema, int codFesta);
	...
	@Query(value = "SELECT asp.codHistorico from AreaSegurancaProblemaFluxo asp WHERE asp.codFesta = :codFesta AND codUsuarioResolv IS NOT NULL")
	public List<Integer> findAreaProblemaFestaPorUsuarioStatus(int codFesta);
	
	@Query(value = "SELECT asp from AreaSegurancaProblemaFluxo asp WHERE asp.codHistorico = :codHistorico")
	public AreaSegurancaProblemaFluxo findProblemaAreaHistorico(int codHistorico);
}
