...
public class FestaFactoryTest {
	...
	public void getFestaSucessoTest() throws Exception {
		...
		//assertEquals( festa.getHorarioFimFestaReal(), festaTO.getHorarioFimFestaReal());
	...
	@Test
	public void getFestaTOSucessoTest() throws Exception {
	...
	@Test
	public void getFestaTOSucesso2Test() throws Exception {
		Festa festa = festaTest();
		List<UsuarioTO> usuariosTO = new ArrayList<>();
		usuariosTO.add(usuarioTOTest());
		CategoriaTO categoriaTO1 = categoriaTOTest();
	...
	@Test
	public void getFestaTOSucessoUsuarioNullTest() throws Exception {
		Festa festa = festaTest();
		List<UsuarioTO> usuariosTO = new ArrayList<>();
		usuariosTO.add(usuarioTOTest());
		CategoriaTO categoriaTO1 = categoriaTOTest();
	...
	@Test
	public void getFestaTOSucessoAlterTest() throws Exception {
		...
		FestaTO festaTO = festaFactory.getFestaTO(festa, usuariosTO, false, categoriaTO1, categoriaTO2, convidadosTO, 2);
