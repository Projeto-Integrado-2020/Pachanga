 ...
 */
	...
	@Test
	public void Sample1p9() throws IOException {
	...
	@Test
	public void Sample1p10() throws IOException {
	...
	@Test
	public void Sample1p8() throws IOException {
	...
	@Test
	public void Sample1p7() throws IOException {
	...
	@Test
	public void Sample1p5() throws IOException {
	...
	@Test
	public void Sample1p6() throws IOException {
	...
	@Test
	public void Sample1p1() throws IOException {
		...
		PDDocument doc = new PDDocument();
		PDPage page = addNewPage(doc);
		float yStartNewPage = page.getMediaBox().getHeight() - (2 * margin) - 1000;
	...
	@Test
	public void Sample1p2() throws IOException {
		...
		float yStart = yStartNewPage;
		float bottomMargin = 70;
		BaseTable table = new BaseTable(yStart, yStartNewPage, bottomMargin, tableWidth, margin, doc, page, false,
				drawContent);
	...
	@Test
	public void Sample1p3() throws IOException {
	...
	@Test
	public void Sample1p4() throws IOException {
 ...
 */
	...
	@Test
	public void SampleTest3p2() throws IOException {
		// Set margins
		float margin = 10;
		...
		// Create Header row
		Row<PDPage> row = table.createRow(15f);
		Cell<PDPage> cell = row.createCell((100 / 3f), "Hello", HorizontalAlignment.get("right"),
				VerticalAlignment.get("top"));
		cell.setTextRotated(true);
		cell.setFont(PDType1Font.HELVETICA);
		cell.setFontSize(6);

		Cell<PDPage> cell2 = row.createCell((100 / 3f), "It's me", HorizontalAlignment.get("right"),
				VerticalAlignment.get("middle"));
		cell2.setTextRotated(true);
		cell2.setFont(PDType1Font.HELVETICA);
		cell2.setFontSize(6);

		Cell<PDPage> cell3 = row.createCell((100 / 3f), "I was wondering", HorizontalAlignment.get("right"),
				VerticalAlignment.get("bottom"));
		cell3.setTextRotated(true);
		cell3.setFont(PDType1Font.HELVETICA);
		cell3.setFontSize(6);
		...
		Row<PDPage> row2 = table.createRow(15f);
		Cell<PDPage> cell4 = row2.createCell((100 / 3.0f), "Hello", HorizontalAlignment.get("right"),
				VerticalAlignment.get("top"));
		cell4.setFont(PDType1Font.HELVETICA);
		cell4.setFontSize(6);

		Cell<PDPage> cell5 = row2.createCell((100 / 3f), "can you hear me?", HorizontalAlignment.get("right"),
				VerticalAlignment.get("middle"));
		cell5.setTextRotated(true);
		cell5.setFont(PDType1Font.HELVETICA);
		cell5.setFontSize(6);
	...
	@Test
	public void SampleTest3p1() throws IOException {
		// Set margins
		float margin = 10;
		...
		// Create Header row
		Row<PDPage> row = table.createRow(15f);
		Cell<PDPage> cell = row.createCell((100 / 3f), "Hello", HorizontalAlignment.get("left"),
				VerticalAlignment.get("top"));
		cell.setTextRotated(true);
		cell.setFont(PDType1Font.HELVETICA);
		cell.setFontSize(6);

		Cell<PDPage> cell2 = row.createCell((100 / 3f), "It's me", HorizontalAlignment.get("left"),
				VerticalAlignment.get("middle"));
		cell2.setTextRotated(true);
		cell2.setFont(PDType1Font.HELVETICA);
		cell2.setFontSize(6);

		Cell<PDPage> cell3 = row.createCell((100 / 3f), "I was wondering", HorizontalAlignment.get("left"),
				VerticalAlignment.get("bottom"));
		cell3.setTextRotated(true);
		cell3.setFont(PDType1Font.HELVETICA);
		cell3.setFontSize(6);
		...
		Row<PDPage> row2 = table.createRow(15f);
		Cell<PDPage> cell4 = row2.createCell((100 / 3.0f), "Hello", HorizontalAlignment.get("left"),
				VerticalAlignment.get("top"));
		cell4.setFont(PDType1Font.HELVETICA);
		cell4.setFontSize(6);

		Cell<PDPage> cell5 = row2.createCell((100 / 3f), "can you hear me?", HorizontalAlignment.get("left"),
				VerticalAlignment.get("middle"));
		cell5.setTextRotated(true);
		cell5.setFont(PDType1Font.HELVETICA);
		cell5.setFontSize(6);
 ...
 */
	...
	@Test
	public void SampleTest4p1() throws IOException {
 ...
 */
	...
	@Test
	public void SampleTest10p1() throws IOException {
		...
		Cell<PDPage> cell10 = row4.createCell((100 / 3f),
				...
				HorizontalAlignment.get("center"), VerticalAlignment.get("top"));
		cell10.setFontSize(6);
		cell10.setTextRotated(true);
		cell10.setAlign(HorizontalAlignment.CENTER);
		cell10.setValign(VerticalAlignment.MIDDLE);

		Cell<PDPage> cell11 = row4.createCell((100 / 3f),
				"<p>SINGLE SPACING</p><p>Proin dui dolor, lacinia at dui at, placerat ullamcorper arcu. Sed auctor sagittis elit, at eleifend ex aliquet ut. Duis lobortis est nec placerat condimentum. Aliquam erat volutpat. In a sem massa. Phasellus eget tortor iaculis, condimentum turpis a, sodales lorem. Aenean egestas congue ex<i> eu condimentum. Fusce sed</i> fringilla lorem. Vestibulum luctus ni<b>si ac turpis congue, vitae pharetra lorem suscipit.</b></p>Ordered List <ol><li>Item 1</li><li>Item 2</li><li>Item 3</li></ol>",
				HorizontalAlignment.get("center"), VerticalAlignment.get("middle"));
		cell11.setFontSize(6);
		cell11.setTextRotated(true);
		cell11.setAlign(HorizontalAlignment.CENTER);
		cell11.setValign(VerticalAlignment.MIDDLE);
	...
	@Test
	public void SampleTest10p2() throws IOException {
		...
		cell10.setTextRotated(true);
		cell10.setAlign(HorizontalAlignment.CENTER);
		cell10.setValign(VerticalAlignment.BOTTOM);
		...
		cell11.setTextRotated(true);
		cell11.setAlign(HorizontalAlignment.CENTER);
		cell11.setValign(VerticalAlignment.BOTTOM);
	...
	@Test
	public void SampleTest10p3() throws IOException {
 ...
 */	
	...
	public void SampleTest11() throws IOException {
		...
		PDStreamWrite(cos, "Welcome to your first borderless table", PDType1Font.HELVETICA_BOLD, 14, 15, yStart,
				Color.BLACK);
		cos.close();
